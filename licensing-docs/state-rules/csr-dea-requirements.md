...
| Kentucky | Kentucky CSR | Required |
| Louisiana | Louisiana CSR | Required |
| Maryland | Maryland CSR | Required |
| Mississippi | Mississippi CSR | Required |
| Missouri | Missouri CSR | Required |
| Nebraska | Nebraska CSR | Required |
| North Carolina | NC CSR | Required |
| Ohio | Ohio CSR | Required |
| Oklahoma | Oklahoma CSR | Required |
| South Carolina | SC CSR | Required |
| Tennessee | TN CSR | Required |
| Texas | DPS CSR | Required — separate from DEA |
